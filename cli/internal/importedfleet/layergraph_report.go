...
func LayerGraphMarkdown(graph LayerGraph) string {
	...
	fmt.Fprintf(&b, "How much of each image is content nothing else in the fleet carries. A high unique share means remediating that image benefits only that image.\n\n")
