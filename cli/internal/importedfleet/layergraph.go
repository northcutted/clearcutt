...
const (
	// defaultCoverageThreshold is the share of the fleet a layer must appear in to
...
// CommonLayer is one layer carried by at least the coverage threshold of the fleet.
