...
2. Run the release workflow to publish the configured fleet to %[2]s.
3. Let the catalog workflow run %[3]d-release ingestion with vulnerability scan depth %[4]s.
4. Give app teams the templates under %[5]s.
5. Enforce signatures, SBOMs, SLSA Build L3 provenance, and rebase attestations at CI and admission.
