...
// layer — the shape a well-governed estate actually has, and the shape that used
...
// TestLayerGraphScalesPastTheOldImageCutoff is the behaviour change. Pairwise
...
// feature.
func TestLayerGraphScalesPastTheOldImageCutoff(t *testing.T) {
	const images = 2000
